...
import { Search, SquarePen, X, Clipboard } from "lucide-react"
        ...
        <div>
            ...
            <div className="space-y-6">
                ...
                <div>
                    ...
                    <textarea rows={3} className="custom-input resize-none"
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-[1.3fr_2fr]">
                    <div>
                        ...
                        <div className="relative">
                            <input className="custom-input pr-10"
                                value={tagInput}
                ...
                <div>
                    ...
                    <textarea rows={4} className="custom-input resize-none w-full"
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-[1.3fr_2fr]">
                    <div>
                        ...
                        <textarea rows={3} className="custom-input resize-none w-full"
                ...
                <div className="grid grid-cols-1 gap-4 lg:grid-cols-[1.3fr_2fr]">
                    ...
                    <div>
                        {coverImage ? (
                            <div className="relative border-2 border-dashed rounded-lg p-4 h-full">
                                <img
                            ...
                            <label className="flex h-full flex-col items-center justify-center rounded-lg border-2 border-dashed text-center cursor-pointer hover:bg-gray-50 min-h-[200px]">
                                <input
                                    type="file"
                                    accept="image/*"
                                ...
                                <div className="flex gap-4">
                                    <label className="flex gap-2">
                                        <input type="radio"
                                            ...
                                            onChange={(e) => handleSEOChange('googleBot', e.target.checked ? 'ALLOW' : 'DISALLOW')}
                                        /> Allow
                                    </label>
                                    <label className="flex gap-2">
                                        <input type="radio"
                                            checked={form.seo.googleBot === 'DISALLOW'}
                                            onChange={(e) => handleSEOChange('googleBot', e.target.checked ? 'DISALLOW' : 'ALLOW')}
                                        /> Disallow
                                    </label>
                                </div>
                            </div>
                ...
                <div>
                    {pdfFile ? (
                        ...
                        <label className="flex h-[180px] flex-col items-center justify-center rounded-lg border-2 border-dashed text-center cursor-pointer hover:bg-gray-50">
                            <input
                                type="file"
                                accept=".pdf"
                                ...
                                className="hidden"
                            />
                            <img src={vid} className="mb-3 w-12 opacity-80" />
                            <p className="text-sm font-semibold">
