...
router.post("/register", authLimiter, requireAuth, catchAsync(authController.register));
...
router.post("/logoutAll", authLimiter, requireAuth, catchAsync(authController.logoutAll));
